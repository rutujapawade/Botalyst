...
# @app.route('/result/<user_id>/<file_name>')
# def get_result_file(user_id, file_name):
#     # Security: check karein ki user wahi hai
#     if str(session.get("user_id")) != str(user_id):
#         abort(403) # Access Denied
    
#     # File serve karein
#     return send_from_directory(REPORT_FOLDER, file_name)
@app.route('/api/download-report/<report_name>')
def download_report(report_name):
    # Ab yahan seedhe report_name se file bhej dein
    return send_from_directory(REPORT_FOLDER, report_name)
